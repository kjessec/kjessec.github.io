...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Survey = __webpack_require__(198);
	...
	// create an empty div
	var mountTo = document.createElement('div');

	// start react app and mount to our container
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxActions = __webpack_require__(53);
	...
	}), _defineProperty(_handleActions, ADD_PERSON, function (state, action) {
	  var people = state.people.slice(0);
	  people.push({
	    name: 'name',
	    age: 17
	  });
	...
	}), _defineProperty(_handleActions, SAVE_STATE, function (state, action) {
	  return _extends({}, state, {
	    isModified: false
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAction = __webpack_require__(54);

	var _createAction2 = _interopRequireDefault(_createAction);

	var _handleAction = __webpack_require__(55);

	var _handleAction2 = _interopRequireDefault(_handleAction);

	var _handleActions = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(57);

	var _ownKeys2 = _interopRequireDefault(_ownKeys);

	var _reduceReducers = __webpack_require__(58);
	...
	var Survey = function (_React$Component) {
	  ...
	  _createClass(Survey, [{
	    ...
	    value: function render() {
	      ...
	      var ADD_PERSON = _props.ADD_PERSON;
	      var SAVE_STATE = _props.SAVE_STATE;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', {
	            type: 'text',
	            value: survey.meta.author,
	            onChange: function onChange(ev) {
	              survey.meta.author = String(ev.target.value);
	            }
	          })
	        ),
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          survey.people.map(function (person, idx) {
	            return _react2.default.createElement(
	              'div',
	              { key: idx },
	              _react2.default.createElement(
